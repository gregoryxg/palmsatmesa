...
@section('content')
    ...
    <div class="container h-100">
        <div class="row align-items-center h-100">
            <div class="mx-auto">
                <img src="{{ asset(Storage::temporaryUrl($user->profile_picture, now()->addMinutes(5))) }}" height="200px" alt="https://placehold.jp/150x200.png" class="img-rounded img-responsive">
