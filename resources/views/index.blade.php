...
@endif
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140"><image xlink:href="{{ asset(Storage::url("public/about/palms_at_mesa_about.jpg")) }}" width="100%" height="100%"/></svg>
                <h2>About</h2>
            ...
            <div class="col-lg-4">
                <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140"><image xlink:href="{{ asset(Storage::url("public/about/palms_at_mesa_ammenities.jpg")) }}" width="100%" height="100%"/></svg>
                <h2>Ammenities</h2>
            ...
            <div class="col-lg-4">
                <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140"><image xlink:href="{{ asset(Storage::url("public/about/palms_at_mesa_proximity.jpg")) }}" width="100%" height="100%"/></svg>
                <h2>Proximity</h2>
