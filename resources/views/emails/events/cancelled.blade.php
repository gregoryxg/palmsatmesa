...
<br/>Your refund of ${{ number_format(($event->reservable->reservation_fee - (($event->reservable->reservation_fee*.029) + 30))/100, 2, '.', ' ')  }} will be processed in 5-10 business days</s>
<br/>
